...
class UsersSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Users
        fields = ['first_name', 'last_name', 'email', 'password', 'access_role', 'status', 'user_roles', 'username',
                  'uuid']
        extra_kwargs = {
...
class UsersDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Users
        fields = ['scope', 'first_name', 'last_name', 'email', 'status', 'access_role', 'user_roles','password',
                  'uuid','filter']
        extra_kwargs = {
            'user_roles': {'write_only': True},
            'password': {'write_only': True}
